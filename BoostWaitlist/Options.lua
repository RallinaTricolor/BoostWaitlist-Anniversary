...
category, layout = Settings.RegisterCanvasLayoutCategory(about, about.name, about.name);
category.ID = about.name
Settings.RegisterAddOnCategory(category);

local subcategory, layout = Settings.RegisterCanvasLayoutSubcategory(category, general, general.name);
local subcategory, layout = Settings.RegisterCanvasLayoutSubcategory(category, playerDB, playerDB.name);
